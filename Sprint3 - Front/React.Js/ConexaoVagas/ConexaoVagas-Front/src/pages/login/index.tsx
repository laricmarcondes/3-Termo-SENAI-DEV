...
import { API_URL, handleErrors, TOKEN_KEY } from '../../api/apisettings';
import { Jwt, parseJwt } from '../../services/auth';
        ...
        fetch(API_URL + 'Login', {
            ...
            .then(dados => {
                if (dados.token !== undefined) {
                    ...
                    else if (jwt.Role == TipoUsuario.CANDIDATO) history.push('/Candidato/vagas');
                } else {
                ...
                <div className="login flex flex-col w-full m-24 ">
                    ...
                    <form onSubmit={event => {
                        ...
                        <div className="lg:pr-10 lg:pl-10">
                            <Input type="text" name="Email" label="Insira seu email:" placeholder="email@email.com" 
                                className="input mt-16"
                                onChange={e => setEmail(e.target.value)} value={email}/>

                            <div className="flex justify-between">
                                <Input type="password" name="Senha" label="Insira sua senha:" placeholder="*******" 
