                ...
                <form className="m-auto lg:w-1/2 w-full"
                    ...
                    <div className="mb-5 text-center">
                        ...
                        <input id="c-upload-photo" className="hidden" type="file"
                            ...
                            accept="image/*" />
                        <label className="button-normal cursor-pointer
                    ...
                    <div className="input-container mt-2 gap-1">
                        <b>Número de matrícula do SENAI: </b>
                    ...
                    <div className="flex flex-row flex-wrap md:text-base text-xs ">
                        {renderHabilidades()}
                    </div>
