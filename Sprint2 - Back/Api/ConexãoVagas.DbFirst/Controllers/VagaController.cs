...
namespace ConexaoVagasAPI.Controllers
{
    ...
    public class VagaController : ControllerBase
    {
        ...
        /// <summary>
        /// Busca uma vaga através do titulo
        /// </summary>
        /// <param name="titulo"></param>
        /// <returns>A vaga buscada com suas informações</returns>
        [Authorize(Roles = "1,2,3")]
        [HttpGet("pesquisarTitulo/{name}")]
        public IActionResult GetByName(string titulo)
        {
            //Retorna os dados buscados e um status code 200 - Ok
            return StatusCode(200, _vagaRepository.BuscarPorTitulo(titulo));
        }
